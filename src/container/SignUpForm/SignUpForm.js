...
class SignUpForm extends React.Component {
  ...
  componentWillReceiveProps = async (nextProps) => {
    ...
    if (nextProps.updatemanager) {
      if (nextProps.updatemanager.success === true) {
  ...
  updateProfile = async () => {
    ...
    else if (this.state.contactNumber == '' || this.state.contactNumber == null) {
  ...
  render() {
    ...
    const prevScreen = navigation && navigation.state && navigation.state.params && navigation.state.params.prevScreen;
    return (
