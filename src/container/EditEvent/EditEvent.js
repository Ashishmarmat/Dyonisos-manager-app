...
import { updateeventAPI } from '../../actions/UpdateEvent';
  ...
  componentWillMount = async () => {
    ...
    this.setState(
      ...
      () => {
        ...
        this.props.ViewEventsubmitForm(payLoad);
      },
    );
  ...
  componentWillReceiveProps = async (nextProps) => {
    ...
    if (nextProps.viewevent) {
      if (nextProps.viewevent.success === true) {
       ...
       if (nextProps.updateevent) {
      if (
        nextProps.updateevent.success === true &&
        nextProps.updateevent.success !== this.props.updateevent.success
      ) {
        ...
        <ScrollView style={styles.Container}>
          ...
          <View style={styles.cardView}>
            <View style={{ flexDirection: 'row' }}>
              <TextInput
                ...
                value={this.state.EventDetails.eventVenue}
              />
              <TouchableOpacity
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={{ marginRight: h(5) }}>
              ...
              <DatePicker
                ...
                date={this.state.EventDetails.eventStartDate}
                mode="date"
            ...
            <View>
              ...
              <DatePicker
                ...
                date={this.state.EventDetails.eventEndDate}
                mode="date"
                placeholder="YYYY-MM-DD"
                format="YYYY-MM-DD"
          ...
          <View style={styles.desCardView}>
            <TextInput
              ...
              value={this.state.EventDetails.eventDetails}
            />
          </View>
              ...
              <View
                ...
                <View style={styles.addAmountView}>
                  <TextInput
                    ...
                    value={this.state.EventDetails.totalTickets}
                  />
                </View>
              </View>
            </View>
                ...
                <View
                  ...
                  <View style={styles.addAmountView}>
                    ...
                    <TextInput
                      ...
                      value={this.state.EventDetails.ticketPrice}
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={{ marginRight: h(5) }}>
              ...
              <DatePicker
                ...
                borderWidth={0}
                date={this.state.EventDetails.ticketSellingStartDate}
                mode="date"
                placeholder="YYYY-MM-DD"
                format="YYYY-MM-DD"
                minDate={moment().toDate()}
            ...
            <View>
              ...
              <DatePicker
                ...
                date={this.state.EventDetails.ticketSellingEndDate}
                mode="date"
                placeholder="YYYY-MM-DD"
                format="YYYY-MM-DD"
                minDate={this.state.eventStartDate}
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    submitForm: (data) => dispatch(updateeventAPI(data)),
    ...
    ViewEventsubmitForm: (data) => dispatch(vieweventAPI(data)),
  };
};
...
// import { vieweventAPI } from '../../actions/ViewEventDetails';
// import styles from './styles';
// import { w, h, width } from '../../utils/Dimensions';
...
//     if (
//       this.state.eventImg == '' ||
//       this.state.eventImg == null ||
//       this.state.eventImg == []
//     ) {
//       return require('../../assets/assest/assest/icon-01-01.png');
//     } else {
//       return {
...
//     var eventStartDate = await AsyncStorage.getItem('eventStartDate');
//     var eventStartTime = await AsyncStorage.getItem('eventStartTime');
//     var eventEndDate = await AsyncStorage.getItem('eventEndDate');
//     var eventEndTime = await AsyncStorage.getItem('eventStartDate');
//     var eventVenue = await AsyncStorage.getItem('eventVenue');
//     var eventDetails = await AsyncStorage.getItem('eventDetails');
//     var eventImg = await AsyncStorage.getItem('eventImg');
//     var ticketPrice = await AsyncStorage.getItem('ticketPrice');
//     var totalTickets = await AsyncStorage.getItem('totalTickets');
//     var categoryName = await AsyncStorage.getItem('categoryName');
//     var ticketSellingStartDate = await AsyncStorage.getItem(
//       'ticketSellingStartDate',
//     );
//     var ticketSellingEndDate = await AsyncStorage.getItem(
//       'ticketSellingEndDate',
//     );
//     var eventType = await AsyncStorage.getItem('eventType');
//     var eventStatus = await AsyncStorage.getItem('eventStatus');
//     this.setState({
//       managerId: managerId,
//       username: username,
//       token: token,
...
//   };
//   componentWillReceiveProps = async (nextProps) => {
//     console.log('nextPropssss', nextProps);
//     this.setState({
//       isLoading: false,
//     });
//     if (nextProps.viewevent) {
...
//         this.setState(
//           {
//             eventdetail: [nextProps.viewevent.datalist],
//           },
//         );
//         console.log('eventdetail@@', nextProps.viewevent.datalist);
//         let eventStartDate = '';
//         let eventEndDate = '';
//         let ticketSellingStartDate = '';
//         let ticketSellingEndDate = '';
//         console.log('eventStartDatedatadata', nextProps.viewevent.datalist.eventStartDate);
//         eventStartDate = moment(nextProps.viewevent.datalist.eventStartDate).format('YYYY-MM-DD');
//         eventEndDate = moment(nextProps.viewevent.datalist.eventEndDate).format('YYYY-MM-DD');
//         ticketSellingStartDate = moment(nextProps.viewevent.datalist.ticketSellingStartDate).format(
//           'YYYY-MM-DD',
//         );
//         ticketSellingEndDate = moment(nextProps.viewevent.datalist.ticketSellingEndDate).format(
//           'YYYY-MM-DD',
//         );
//         this.setState({
//           eventStartDate: eventStartDate,
...
//       if (nextProps.sponsorslist.success === true) {
//         this.setState({
//           sponsorsList: nextProps.sponsorslist.data,
//         });
//       }
//       console.log('aaaa sponsorsList', this.state.sponsorsList);
//     }
...
//     if (this.state.eventName == '' || this.state.eventName == null) {
//       Alert.alert('Please enter event name');
//     } else if (this.state.eventVenue == '' || this.state.eventVenue == null) {
...
//         eventVenue: this.state.eventVenue,
//         eventType: this.state.eventType,
//         totalTicket: this.state.totalTickets,
//         ticketPrice: this.state.ticketPrice,
//         eventSponsors: SelectSponsor,
//         eventImg: tempEventImagesArray,
//         lat: 123,
...
//       ticketSellingStartDate: ticketSellingStartDate,
//     });
//     console.log('ticketSellingStartDate', ticketSellingStartDate);
//   };
//   onchangeTcktEnd = (date, value2) => {
//     console.log('value2', value2);
//     console.log('date', date);
...
//       ticketSellingEndDate: ticketSellingEndDate,
//     });
//     console.log('ticketSellingEndDate', ticketSellingEndDate);
//   };
//   /////////////////////////////////////////////////////////////////////////////
//   displaystatus = (data) => {
//     return (
...
//   selectStatus = (idx, value) => {
//     console.log('jkagshagsfdjhfds', value);
//     this.setState({
//       eventStatus: value.eventStatus,
//     });
//   };
...
//   selectCategory = (idx, value) => {
//     console.log('categoryNameValue', value);
//     this.setState({
//       categoryName: value.categoryName,
//       subCategoryName: '',
//     });
...
//   selectSubCategory = (idx, value) => {
//     console.log('subCategoryNameValue', value);
//     this.setState({
//       subCategoryName: value.subCategoryName,
//     });
//   };
...
//                 flex: 2,
//               }}>
//               <Text style={styles.headingText}>Edit event</Text>
//             </View>
//             <View
//               style={{
//                 flex: 2,
...
//         </ImageBackground>
//         <ScrollView style={styles.Container}>
//           {this.state.eventdetail != undefined &&
//             this.state.eventdetail.map((eventItem, eventIndex) => (
//               <View key={eventIndex}>
//                 <Text style={styles.titleText}>Event title</Text>
//                 <View style={styles.cardView}>
//                   <TextInput
...
//                     renderRow={(row) => this.displaySubCategory(row)}
//                     onSelect={(idx, value) =>
//                       this.selectSubCategory(idx, value)
//                     }>
//                     <View
//                       style={{
//                         flexDirection: 'row',
...
//                       mode="date"
//                       placeholder={eventItem.eventStartDate}
//                       format="YYYY-MM-DD"
//                       minDate={moment().toDate()}
//                       // maxDate="2016-06-01"
//                       confirmBtnText="Confirm"
...
//                       mode="date"
//                       placeholder={eventItem.eventEndDate}
//                       format="YYYY-MM-DD"
//                       minDate={this.state.eventStartDate}
//                       // maxDate="2016-06-01"
//                       confirmBtnText="Confirm"
...
//                                 alignItems: 'center',
//                               }}
//                               placeholder={eventItem.eventStartTime}
//                               editable={false}>
//                               {this.state.eventStartTime}
//                             </TextInput>
//                           </TouchableOpacity>
...
//                               alignItems: 'center',
//                             }}
//                             placeholder={eventItem.eventEndTime}
//                             editable={false}>
//                             {this.state.eventEndTime}
//                           </TextInput>
//                         </TouchableOpacity>
...
//                     value={eventItem.eventDetails}
//                   />
//                 </View>
//                 <Text style={styles.titleText}>Add sponsors</Text>
//                 <View
//                   style={{
//                     flexDirection: 'row',
//                     justifyContent: 'space-between',
...
//                       <TouchableOpacity
//                         style={{ height: h(6.6), width: h(6.6) }}
//                         onPress={this.chooseFile}>
//                         <View style={{ height: h(6.5), width: h(6.5) }}>
//                           {item.filename && item.filename !== '' ? (
//                             <ImageBackground
...
//                               this.setState({ ticketPrice: ticketPrice })
//                             }
//                             value={eventItem.ticketPrice}
//                             editable={
//                               this.state.eventType === 'Paid' ? true : false
//                             }
//                           />
//                         </View>
//                       </View>
...
//                       mode="date"
//                       placeholder={eventItem.ticketSellingStartDate}
//                       format="YYYY-MM-DD"
//                       minDate={moment().toDate()}
//                       maxDate={this.state.eventStartDate}
//                       confirmBtnText="Confirm"
...
//                       mode="date"
//                       placeholder={eventItem.ticketSellingEndDate}
//                       format="YYYY-MM-DD"
//                       minDate={this.state.eventStartDate}
//                       maxDate={this.state.eventEndDate}
//                       confirmBtnText="Confirm"
